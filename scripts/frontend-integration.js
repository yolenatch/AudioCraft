 ...
 * This file demonstrates how to integrate Audiocraft with a web frontend
 */

// For React/Vue/Angular applications
export class AudiocraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new AudiocraftClient(provider, contractAddress);
